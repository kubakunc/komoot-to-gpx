...
```
Komoot & Strava als GPX exportieren — für Garmin, Wahoo, Radcomputer & Uhren.
```
...
AUCH MIT STRAVA
Melde dich mit Strava an und exportiere auch deine Aktivitäten und geplanten Routen als GPX — praktisch, da die Strava-App keinen GPX-Export auf dem Handy erlaubt. Wenn du bei beiden angemeldet bist, wechselst du mit einem Tipp zwischen Komoot und Strava.

DEINE ROUTEN, JEDES GERÄT
Eine Route, die du geplant oder aufgezeichnet hast, gehört dir. Als GPX-Datei exportiert kannst du mit jedem Gerät navigieren — Garmin oder Wahoo Radcomputer, Sportuhr oder eine andere Karten-App — während du weiter mit Komoot oder Strava planst.
...
KEINE VERBINDUNG ZU KOMOOT ODER STRAVA
Dies ist ein Drittanbieter-Tool. "Komoot" und "Strava" sind Marken ihrer jeweiligen Inhaber (komoot GmbH und Strava, Inc.). Wir sind mit keinem der beiden verbunden und werden von ihnen weder unterstützt noch gesponsert. Die App nutzt dein eigenes Konto, um deine eigenen Daten abzurufen.
...
komoot gpx export, komoot tour herunterladen, komoot gpx datei, komoot garmin, komoot wahoo, gpx download, strava gpx export, strava route gpx, strava aktivität gpx, strava garmin, strava wahoo
