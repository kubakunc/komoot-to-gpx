...
**Date:** 2026-05-11
**Status:** approved
**Bundle ID:** `com.velologiclabs.gpxexporter`
...
| Bundle ID | `com.velologiclabs.gpxexporter` | Final on first upload, chosen up front |
| Publisher | VeloLogic Labs | Brand under which the app ships on Play |
...
```
┌──────────────────────────────────────────────────────┐
│  Android APK — com.velologiclabs.gpxexporter                  │
│                                                       │
│  ┌────────────────────────────────────────────────┐  │
│  │ Native (Kotlin)                                │  │
...
- `android/app/src/main/java/com/velologiclabs/gpxexporter/KomootAuthPlugin.kt` (~120 LOC)
- `android/app/src/main/java/com/velologiclabs/gpxexporter/LoginActivity.kt` (~80 LOC)
...
- Contact: contact@velologic-labs.eu (placeholder — confirm before publishing).
