...
No backend server. The SvelteKit SPA compiles to static files inside `android/app/src/main/assets/public`. The native shell packages everything into one AAB.
...
## 6. Code changes from current PWA
